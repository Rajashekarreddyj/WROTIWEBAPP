...
class Customer {
  ...
  public function login($email, $password, $override = false) {
	...
	public function login_new($telephone,$store_id) {
		$customer_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer WHERE LOWER(telephone) = '" . $this->db->escape(utf8_strtolower($telephone)). "' AND store_id = '" . (int)$store_id . "'");
