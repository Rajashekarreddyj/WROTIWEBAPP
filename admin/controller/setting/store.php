...
class ControllerSettingStore extends Controller
{
	...
	protected function getList()
	{
		...
		if ($this->user->getUserGroup() == "Admin") {
	...
	protected function getForm()
	{
		...
		if (isset($this->request->post['config_rating'])) {
			$data['config_rating'] = $this->request->post['config_rating'];
		} elseif (isset($store_info['config_rating'])) {
			$data['config_rating'] = $store_info['config_rating'];
		} else {
			$data['config_rating'] = '';
		}
		if (isset($this->request->post['config_brands'])) {
			$data['config_brands'] = $this->request->post['config_brands'];
		} elseif (isset($store_info['config_brands'])) {
			$data['config_brands'] = $store_info['config_brands'];
		} else {
			$data['config_brands'] = '';
		}
		if (isset($this->request->post['config_promotions'])) {
			$data['config_promotions'] = $this->request->post['config_promotions'];
		} elseif (isset($store_info['config_promotions'])) {
			$data['config_promotions'] = $store_info['config_promotions'];
		} else {
			$data['config_promotions'] = '';
		}
		...
		if (isset($this->request->post['config_location_distance'])) {
			$data['config_location_distance'] = $this->request->post['config_location_distance'];
		} elseif (isset($store_info['config_location_distance'])) {
			$data['config_location_distance'] = $store_info['config_location_distance'];
		} else {
			$data['config_location_distance'] = $this->config->get('config_location_distance');
		}

		if (isset($this->request->post['config_delivery_charges'])) {
			$data['config_delivery_charges'] = $this->request->post['config_delivery_charges'];
		} elseif (isset($store_info['config_delivery_charges'])) {
			$data['config_delivery_charges'] = $store_info['config_delivery_charges'];
		} else {
			$data['config_delivery_charges'] = $this->config->get('config_delivery_charges');
		}
		...
		} elseif (isset($store_info['config_api'])) {
			$data['config_api'] = $store_info['config_api'];
		} else {
			$data['config_api'] = $this->config->get('config_api');
		}

		if (isset($this->request->post['config_payments'])) {
			$data['config_payments'] = $this->request->post['config_payments'];
		} elseif (isset($store_info['config_payments'])) {
			$data['config_payments'] = $store_info['config_payments'];
		} else {
			$data['config_payments'] = $this->config->get('config_payments');
		}
		...
		if (isset($this->request->post['config_languages'])) {
			$data['config_languages'] = $this->request->post['config_languages'];
		} elseif (isset($store_info['config_languages'])) {
			$data['config_languages'] = $store_info['config_languages'];
		} else {
			$data['config_languages'] = $this->config->get('config_languages');
		}
