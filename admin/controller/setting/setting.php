...
class ControllerSettingSetting extends Controller
{
	...
	public function index()
	{
		...
		if (isset($this->error['config_location_distance'])) {
			$data['error_distance'] = $this->error['warning'];
		} else {
			$data['error_distance'] = '';
		}
		if (isset($this->error['config_delivery_charges'])) {
			$data['error_delivery_charges'] = $this->error['warning'];
		} else {
			$data['error_delivery_charges'] = '';
		}
		...
		if (isset($this->request->post['config_geofence'])) {
			$data['config_geofence'] = $this->request->post['config_geofence'];
		} else {
			$data['config_geofence'] = $this->config->get('config_geofence');
		}
		...
		if (isset($this->request->post['config_rating'])) {
			...
			$data['config_rating'] = $this->config->get('config_rating');
		}
		...
		} elseif ($this->config->get('config_api')) {
		...
		} elseif ($this->config->get('config_languages')) {
			$data['config_languages'] = $this->config->get('config_languages');
		} else {
			$data['config_languages'] = array();
		}
		...
		} elseif ($this->config->get('config_payments')) {
			$data['config_payments'] = $this->config->get('config_payments');
		} else {
			$data['config_payments'] = array();
		}
	...
	protected function validate()
	{
		...
		if (!$this->request->post['config_location_distance']) {
			$this->error['error_distance'] = $this->language->get('error_distance');
		}
