...
class ControllerMarketingCoupon extends Controller
{
	...
	protected function getForm()
	{
		...
		if (isset($this->request->post['coupon_stores'])) {
			$data['coupon_stores'] = $this->request->post['coupon_stores'];
		} elseif (isset($this->request->get['coupon_id'])) {
			$data['coupon_stores'] = $this->model_marketing_coupon->getCouponStores($this->request->get['coupon_id']);
		} else {
			$data['coupon_stores'] = '';
		}
