...
class ControllerCatalogProduct extends Controller
{
	...
	protected function getList()
	{
		...
		$pagination->url = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}&store_id=' . $this->request->get['store_id'], true);
	...
	protected function getForm()
	{
		...
		if (isset($this->request->post['pos_product_id'])) {
			$data['pos_product_id'] = $this->request->post['pos_product_id'];
		} elseif (!empty($product_info)) {
			$data['pos_product_id'] = $product_info['pos_product_id'];
		} else {
			$data['pos_product_id'] = true;
		}
