...
class ControllerCustomerCustomer extends Controller
{
	...
	protected function getList()
	{
		...
		// print_r($data['sort_store_name'] = $this->url->link('setting/store', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true));
		// die;
		...
		$data['sort_store_name'] = $this->url->link('setting/store', 'user_token=' . $this->session->data['user_token'] . '&sort=store.name' . $url, true);
