...
class ModelSettingStore extends Model {
	public function addStore($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "store SET name = '" . $this->db->escape($data['config_name']) . "', `url` = '" . $this->db->escape($data['config_url']) . "', `ssl` = '" . $this->db->escape($data['config_ssl']) . "', `partner_id` = '" . (int)$this->user->getId() . "'");
	...
	public function getStores($data = array()) {
			...
			if($this->user->getUserGroup()=="partner"){
				
				$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "store WHERE partner_id = '" . $this->user->getId() . "' ORDER BY url");
