...
class ModelAccountCustomerGroup extends Model {
	...
	public function getCustomerInGroups($customer_group_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "customer_to_customer_group` WHERE customer_group_id = '" . (int)$customer_group_id . "'");
