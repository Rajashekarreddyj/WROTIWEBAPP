...
class ModelAccountCustomer extends Model
{
	public function addCustomer($data)
	{
		...
		$query = $this->db->query("INSERT INTO " . "oc_customer_to_customer_group SET customer_group_id = '" . (int) $customer_group_id . "' , customer_id = '" . (int) $customer_id . "' , store_id = '" . (int) $data['store_id'] . "'");
	...
	public function getCustomer($customer_id)
	{
		...
		// echo "SELECT * FROM " . DB_PREFIX . "customer WHERE customer_id = '" . (int) $customer_id . "'  AND store_id = '" . (int) $store_id . "'";
		// die;
	...
	{
		//echo "SELECT * FROM " . DB_PREFIX . "customer WHERE customer_id = '" . (int)$customer_id . "'";die;
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer WHERE customer_id = '" . (int) $customer_id . "'");
	...
	public function getCustomerByEmail($email, $store_id)
	{
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer WHERE LOWER(email) = '" . $this->db->escape(utf8_strtolower($email)) . "' AND store_id = '" . (int) $store_id . "'");
